      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {items.map((_, i) => (
          <div key={i} className="bg-white shadow rounded-xl overflow-hidden">
            <img src={`/images/recent${(i % 6) + 1}.jpg`} className="w-full h-40 object-cover" />

            <div className="p-4">
              <h4 className="font-semibold text-sm mb-1">모던 시티 바이크 투어</h4>
              <p className="text-xs text-gray-500 mb-2">도시 속 숨어 있는 자연과 거리의 매력을 발견하는 코스</p>
